...
public abstract interface UserDao {
     ...
     */
    @org.jetbrains.annotations.Nullable()
    @androidx.room.Query(value = "UPDATE TestPlanEntry SET favorite = :favorit WHERE ID = :id")
    public abstract java.lang.Object update(boolean favorit, @org.jetbrains.annotations.NotNull()
     ...
     */
    @org.jetbrains.annotations.Nullable()
    @androidx.room.Query(value = "UPDATE Course SET chosen = :choosen WHERE courseName = :courseName")
